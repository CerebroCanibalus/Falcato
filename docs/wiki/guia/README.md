...
1. [Introducción](introduccion.md) — Hola mundo, estructura de un programa
2. [Tipos y Artículos](tipos-y-articulos.md) — Sistema de tipos, ownership con artículos
3. [Control de Flujo](control-flujo.md) — Condicionales, bucles, ser/estar, subjuntivo
4. [Funciones](funciones.md) — Declaración, parámetros, retorno, FFI
5. [Arrays](arrays.md) — Declaración, literales, `todos`, acceso, asignación
